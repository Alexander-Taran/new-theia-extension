...
import { /* @echo extensionPrefix */CommandContribution} from './/* @echo extensionPath */-contribution';

export default new ContainerModule(bind => {
    bind(CommandContribution).to(/* @echo extensionPrefix */CommandContribution).inSingletonScope();
